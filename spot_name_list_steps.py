...
# 自然とmental_fatigue
# 50世代の時　56, 55, 52, 46, 23, 49, 54, 34, 47, 56
...
# 200世代の時 56, 53, 56, 51, 49, 34, 47, 23, 55, 54, 52, 45, 56
...
# 500世代の時 [[56, 10, 52, 23, 55, 34, 49, 56, 54, 51, 56], 277, 7400.0, 1]
...
# 100世代の時 56, 53, 51, 54, 47, 55, 46, 52, 45, 23, 34, 56
print("観光スポットのリストを入力してください")
# spot_list = [61, 56, 55, 49, 54, 57, 50, 61]#[61, 50, 24, 33, 52, 57, 25, 41, 56, 48, 46, 49, 51, 54, 61]
...
# [自然，風景:1，文化，食，買い物，料金:5，phy:6, men:7, spottime, 観光移動時間:9，観光歩数，スポットの数:11]
print("spot_list : ",spot_list) # sample 10世代[56, 52, 38, 55, 23, 47, 34, 36, 3, 46, 53, 56]
for k in spot_list:
...
for j in range(len(spot_list) - 1):
    sum[4] += tTimeData[spot_list[j]][spot_list[j+1]] + watchData[spot_list[j]]
    # print("tTimeData[spot_list[j]][spot_list[j+1]] : ",tTimeData[spot_list[j]][spot_list[j+1]])
    sum[5] += watchData[spot_list[j]]
...
#print("自然：",sum[0], "，文化：",sum[1], "，身体的疲労：",sum[2], "，精神的疲労：",sum[3], "，観光時間：",sum[4], "，滞在時間：",sum[5])
# print(avg)